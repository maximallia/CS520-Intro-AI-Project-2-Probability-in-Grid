...
public class Agent8 {
	 ...
	 * @see					Agent8#updateRemainingBeliefState(CellInfo, CellInfo, double, double, boolean)
	 */
			...
			if (currCell.getPos().getX() == mazeRunner.cellOfHighestC.getPos().getX() 
				...
				do {
					...
					if (plannedPath == null) { // WE WEREN'T ABLE TO REACH THE CELL WITH THE HIGHEST PROBABILITY
						...
						mazeRunner.updateRemainingBeliefState(currCell, mazeRunner.cellOfHighestC, unreachableOldProb, currManhattan, false);
					}
